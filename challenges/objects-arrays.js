...
function onlyUniversity(graduates){
  let universities =[];
...
console.log(onlyUniversity(graduates));
...
function contactList(graduates){
  let contactInfo =[];
  for (let i = 0; i < graduates.length; i++){
...
console.log(contactList(graduates));
